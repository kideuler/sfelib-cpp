...
static inline void hexa_8_sfunc(double xi, double eta, double zeta, double sfvals[8]);
...
static inline void prism_6_sfunc(double xi, double eta, double zeta, double sfvals[6],
                           double sdvals[18]);
...
static inline void pyra_5_sfunc(double xi, double eta, double zeta, double sfvals[5]);
...
static inline void tet_10_sfunc(double xi, double eta, double zeta, double sfvals[10],
                          double sdvals[30]);
...
static inline void tet_20_sfunc(double xi, double eta, double zeta, double sfvals[20],
                          double sdvals[60]);
...
static inline void tet_35_sfunc(double xi, double eta, double zeta, double sfvals[35],
                          double sdvals[105]);

static inline void tet_4_ncoords(double natcoords[12]);

static inline void tet_4_sfunc(double xi, double eta, double zeta, double sfvals[4]);
...
static inline void tet_56_sfunc(double xi, double eta, double zeta, double sfvals[56],
                          double sdvals[168]);
...
static inline void tet_84_sfunc(double xi, double eta, double zeta, double sfvals[84],
                          double sdvals[252]);
